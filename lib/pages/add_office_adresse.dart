...
class AddOfficeAdressPage extends StatefulWidget {
  final double lat;
  final double lng;

  AddOfficeAdressPage({Key key, this.lat, this.lng}) : super(key: key);
  @override
  AddOfficeAdressPageState createState() => new AddOfficeAdressPageState();
}

class AddOfficeAdressPageState extends State<AddOfficeAdressPage> {
  TextEditingController _adresse;
  RestDatasource api = new RestDatasource();
  LocalAdress _office_datas;
                    ...
                    child: SizedBox(
                        ...
                        child: new RaisedButton(
                          ...
                          onPressed: () async {
                            ...
                            setState(() {
                              _office_datas.adresse = _adresse.text;
                              _office_datas.nom = "Mon bureau";
                              _office_datas.longitude = position.lng;
                              _office_datas.latitude = position.lat;
                              _office_datas.place_id = _placeId;
                            });
                            DatabaseHelper()
                                .getOfficeAdresse()
                                .then((LocalAdress l) {
                              if (l != null) {
                                print("Office adresse " + l.adresse.toString());
                              } else {
                                DatabaseHelper()
                                    .saveOffice(_office_datas)
                                    .then((index) {
                                  AppSharedPreferences().setOfficeSave(true);
                                  Navigator.of(context).pop(_office_datas);
                                });
                              }
                            });
                          },
